...
namespace MarsFramework.Pages
{
    internal class ManageRequests
    {
        ...
        // Dropdown 1st Option
        [FindsBy(How = How.XPath, Using = "(//*[@class='ui avatar circular image'])[1]")]
        private IWebElement DropdownFirstOpt { get; set; }

        // Result 1st Option
        [FindsBy(How = How.XPath, Using = "(//*[@class='image'])[1]")]
        ...
        internal void SendRequest()
        {
            ...
            GlobalDefinitions.ExcelLib.PopulateInCollection(Base.ExcelPath, "SendRequest");
        ...
        internal void VerifySendRequest()
        {
            ...
            GlobalDefinitions.WaitElement(GlobalDefinitions.driver, "XPath", "//div[@class='ui dropdown link item']", 10);
            manageRequestsLink.Click();

            // Wait and click on dropdown menu the second option: Sent requests
            GlobalDefinitions.WaitForElementClickable(GlobalDefinitions.driver, "XPath","//a[@class='item' and @href='/Home/SentRequest']", 10);
            SentRequestsLink.Click();

            // Wait and Assert if the title skill is equal to recorded skill
            GlobalDefinitions.WaitElement(GlobalDefinitions.driver, "XPath","//*[@id='sent-request-section']/div[2]/div[1]/table/tbody/tr[1]/td[2]/a", 10);
            string skillTitleExpected = GlobalDefinitions.driver.FindElement(By.XPath("" + "//*[@id='sent-request-section']/div[2]/div[1]/table/tbody/tr[1]/td[2]/a")).Text;
        ...
        internal void ReceivedRequest()
        {
            ...
            GlobalDefinitions.WaitForElementClickable(GlobalDefinitions.driver, "XPath","//a[@class='item' and @href='/Home/ReceivedRequest']", 10);
        ...
        {
            // Verify the page
            GlobalDefinitions.WaitElement(GlobalDefinitions.driver, "XPath","//*[@id='received-request-section']/div[2]/h2", 10);
            ...
            {
                Task.WaitAll(Task.Delay(2000));
                IList<IWebElement> rows = GlobalDefinitions.driver.FindElements(By.XPath("//tbody//tr"));
                int count = rows.Count();
                Base.test.Log(LogStatus.Pass, "Verify received requests successfully!" );
                Assert.Pass(+count + " Requests recieved ");
            }
            else
            {
